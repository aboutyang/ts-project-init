...
module.exports = {
  ...
  /**
   * You cannot use the editorconfig option inside .prettierrc.
   * Prettier use .editorconfig as the configuration file
   * if .prettierrc does not exist and a .editorconfig file exists.
   */
